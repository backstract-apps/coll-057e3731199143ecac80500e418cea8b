...
app = FastAPI(title='Backstract Generated APIs - coll-057e3731199143ecac80500e418cea8b', debug=False,
              docs_url='/upbeat-brattain-59c0f1aa112d11f0a0f60242ac12000495/docs',
              openapi_url='/upbeat-brattain-59c0f1aa112d11f0a0f60242ac12000495/openapi.json')
...
app.include_router(
    router,
    prefix='/upbeat-brattain-59c0f1aa112d11f0a0f60242ac12000495/api',
    tags=['APIs v1']
)
